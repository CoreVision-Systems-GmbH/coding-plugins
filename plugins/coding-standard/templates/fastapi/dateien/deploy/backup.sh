...
# des Datenbands (DATA_DIR im Container, Volume app_data). Ältere Stände als
# vierzehn Tage werden entfernt.
#
...
find "$ZIEL" -maxdepth 1 -type f \( -name '*.dump' -o -name '*-data.tar.gz' \) \
